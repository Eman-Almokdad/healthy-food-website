...
const HomeSection3 = () => {
  ...
  return (
    <div className="ma-section-categories d-flex flex-column align-items-center" id={styles.ma_section_categories}>
    <p className="text-center " id={styles.title1}>Categories </p>
    <h1 className="text-center pb-5" id={styles.h1_categories}>Our Products</h1>
    ...
    <a href="" className="text-decoration-none"><button class="border-0" id={styles.btn_s3}>Load More <FaArrowCircleRight /></button></a>
    </div>
  )
}
